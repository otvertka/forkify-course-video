...
import icons from 'E:complete-javascript-course-mastercomplete-javascript-course-master\18-forkifystartersrcimgicons.svg'; // импортируем иконки из родит.каталога с пом Parcel 2
console.log(icons);
